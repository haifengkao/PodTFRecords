...
Pod::Spec.new do |s|
  s.name             = 'PodTFRecords'
  s.version          = '0.1.0'
  s.summary          = 'A short description of PodTFRecords.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Hai\ Feng\ Kao/PodTFRecords'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Hai\ Feng\ Kao' => 'haifeng@cocoaspice.in' }
  s.source           = { :git => 'git@github.com:haifengkao/PodTFRecords.git', :tag => s.version.to_s }
